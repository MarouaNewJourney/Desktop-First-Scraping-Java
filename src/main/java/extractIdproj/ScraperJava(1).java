...
public class ScraperJava {
	public final static char  separator=File.separatorChar;
	public final static String cheminLocal=".."+separator+"extractIdproj"+separator+"src"+separator+"main"+separator+"java"+separator;
	public final static String chemin=cheminLocal+"data_extraite"+separator;
	public static float findNumbPages(String lien) throws IOException {
		
		int somme=0;
		
		append.efface(chemin+"json.txt");
		append.efface(chemin+"json2.txt");
		append.efface(chemin+"json0.txt");
		        ...
		        numb2=ScraperJava.findNumbPages(site+chemin1+sec[0]+"?");
	        	    ...
	        	    retour.add(lienP);
	           		 for(int j=0;j<=numb-1;j++) {
	           			...
	           			Compagnies1.add(extraction.extractInfo(site+Links.get(1)+"&page="+j,Lists,search));
	        	   ...
	        	   lienP=site+Links.get(0);
	        	    ...
	        	    retour.add(lienP);
	           		 for(int j=0;j<=numb-1;j++) {
	           			...
	           			Compagnies1.add(extraction.extractInfo(site+Links.get(0)+"&page="+j,Lists,search));
              ...
              retour.add(lien);
	        	retour.add(ScraperJava.findNumbAnnonces(lien));
           		...
           		for(int j=0;j<=numb2-1;j++) {
           			...
           			Compagnies1.add(extraction.extractInfo(lien1,Lists,secteur));
           		 }
				 ...
				 List<String> newLittleList=new ArrayList<String>(); 
	           		 ...
	           		 {
	           			List<String> newLittleList2=extraction.removeDuplicates(Compagnies1.get(x));
	           		 ...
	           		 newList=extraction.removeDuplicates(newLittleList);
	           		 //System.out.println(newList);

	            
		        append.noRepeat(chemin+"json0.txt", newList);
		        Compag=extraction.extractInfoOfEachLine(chemin+"json0.txt");
		        // close the scanner object;  
       			  ...
       			  //public Compagnie(String nom,String site, String ville, String pays, String secteur,String urlImage)
	           		...
	           		append.write(chemin+"json2.txt",data);
	...
	public static void main(String[] args) {
		...
		extraction.removeDuplicates(a);System.out.println(a);
